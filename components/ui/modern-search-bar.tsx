...
export function ModernSearchBar({
  ...
  return (
    <form onSubmit={handleSubmit} className={cn("w-full", className)}>
      <div className="rounded-3xl border border-slate-200/70 bg-white/90 p-4 shadow-[0_15px_35px_-25px_rgba(15,23,42,0.55)] backdrop-blur">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="h-12 w-full rounded-full border-none bg-slate-100/60 pl-12 pr-4 text-base text-slate-900 shadow-inner focus-visible:ring-2 focus-visible:ring-emerald-500"
            />
          </div>
          <Button
            type="submit"
            className="mt-3 h-12 w-full rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-base font-semibold shadow-[0_10px_30px_-15px_rgba(16,185,129,0.9)] transition hover:from-emerald-600 hover:to-green-700 sm:mt-0 sm:w-auto sm:px-6"
          >
            Search
          </Button>
        </div>
